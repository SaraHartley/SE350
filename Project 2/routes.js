...
app.post('/newCount', function (req, res) {
  ...
  console.log(req.body.Funny);
  console.log(req.body.News);
  console.log(req.body.Political);
...
// Starting our server.
app.listen(3000, () => {
 console.log('Go to http://localhost:3000/getCount so you can see the data.');
});
